...
const MockTransakWidget = ({
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (onSuccess) {
        onSuccess({
          transactionId: `mock-transak-${Date.now()}`,
    ...
    <div className="bg-white p-6 rounded-lg border border-gray-200">
      <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
        <div className="flex items-center">
          ...
          <span className="font-medium text-gray-800">Transak Test Mode</span>
        </div>
      ...
      <div className="mb-4">
        <div className="bg-blue-50 p-3 rounded-md mb-4">
          <p className="text-blue-700 text-sm">
            <strong>Test Mode:</strong> This is a simulated Transak widget for development. No real transactions will be processed.
          </p>
        </div>
...
export default MockTransakWidget;
