    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden border border-indigo-100">
      ...
      >
        <div className="flex items-center">
          ...
          <h3 className="font-semibold text-indigo-900">How MoonPay Donations Work</h3>
        </div>
        <div className="flex items-center">
        ...
        <div className="p-5 animate-fadeIn">
          <div className="bg-indigo-50 p-4 rounded-lg mb-5">
            <p className="text-indigo-800">
              MoonPay allows you to make donations using your regular currency (like USD) 
          ...
          <div className="space-y-4 mb-6">
            <div className="flex items-start bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200">
              ...
              <div>
                ...
                <p className="text-gray-600">Make a donation using your credit/debit card in your preferred currency through MoonPay's secure platform.</p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200">
              ...
              <div>
                ...
                <p className="text-gray-600">MoonPay automatically converts your donation to cryptocurrency at the current exchange rate, with full transparency.</p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200">
              ...
              <div>
                ...
                <p className="text-gray-600">The cryptocurrency is securely stored on the blockchain, providing a permanent, transparent record of your donation.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            <div className="flex items-center mb-2">
              ...
              <p className="font-medium text-blue-800">Why Cryptocurrency?</p>
            </div>
            <p className="text-blue-700 ml-12">
              Cryptocurrency donations offer faster transaction times, lower fees, and complete transparency. 
              Your donation is recorded on the blockchain, making it immutable and verifiable.
            </p>
          </div>
        </div>
      )}
...
export default MoonPayExplainer;
