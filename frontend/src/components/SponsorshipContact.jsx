...
const SponsorshipContact = () => {
  ...
  const sponsorshipLevels = [
    { id: 'diamond', name: 'Diamond', description: 'Premier visibility across all platforms and events', price: '$25,000+' },
    { id: 'platinum', name: 'Platinum', description: 'Top-tier recognition and premium promotion opportunities', price: '$15,000' },
    { id: 'gold', name: 'Gold', description: 'Enhanced visibility and promotional benefits', price: '$10,000' },
    { id: 'silver', name: 'Silver', description: 'Standard recognition and promotional placement', price: '$5,000' },
    { id: 'custom', name: 'Custom Partnership', description: 'Tailored sponsorship package to meet your specific goals', price: 'Custom' }
  ];
      ...
      <div className="flex items-center justify-center mb-8">
        {[1, 2, 3].map(step => (
          <div key={step} className="flex items-center">
            ...
            {step < 3 && (
              <div className={`w-12 h-1 ${currentStep > step ? 'bg-indigo-200' : 'bg-gray-200'}`} />
            )}
          </div>
        ))}
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-indigo-500 focus:border-indigo-500`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2 border ${errors.company ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-indigo-500 focus:border-indigo-500`}
            />
  ...
  const renderSponsorshipSelection = () => {
    return (
      <>
        <h3 className="text-xl font-semibold mb-4">Sponsorship Options</h3>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-indigo-600">{level.price}</span>
                    </div>
      ...
      <div className="flex justify-between mt-8">
        ...
        {currentStep < 3 ? (
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`px-6 py-2 bg-indigo-600 text-white rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
            {isLoading ? (
      ...
      <div className="text-center py-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button 
            ...
            className="px-6 py-2 bg-white border border-indigo-600 text-indigo-600 rounded-md hover:bg-indigo-50"
          >
    ...
    <div className="bg-white rounded-lg shadow-xl p-6 md:p-8 max-w-4xl mx-auto">
      ...
      <div className="mt-10 pt-6 border-t border-gray-200">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div className="text-indigo-600 font-bold text-2xl mb-1">50+</div>
            <div className="text-gray-500 text-sm">Corporate Partners</div>
          </div>
          <div>
            <div className="text-indigo-600 font-bold text-2xl mb-1">100K+</div>
            <div className="text-gray-500 text-sm">Platform Users</div>
          </div>
          <div>
            <div className="text-indigo-600 font-bold text-2xl mb-1">$2.5M</div>
            <div className="text-gray-500 text-sm">Funds Raised</div>
          </div>
          <div>
            <div className="text-indigo-600 font-bold text-2xl mb-1">200+</div>
