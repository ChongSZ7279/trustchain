    ...
    try {
      ...
      if (window.ethereum) {
        try {
          ...
          const transaction = await charityContract.methods.fundTask(taskId).send({
            from: account,
            value: amountInWei,
            gas: 200000
          });
    ...
    <div className="bg-white shadow sm:rounded-lg">
      {step === 1 && (
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Fund Task: {taskName}</h3>
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>Your funding will be processed securely using blockchain technology.</p>
          </div>
      ...
      {step === 2 && (
        <div className="px-4 py-5 sm:p-6 text-center">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Processing Your Funding</h3>
      ...
      {step === 3 && (
        <div className="px-4 py-5 sm:p-6 text-center">
          ...
          <h3 className="mt-2 text-lg leading-6 font-medium text-gray-900">Funding Successful!</h3>
          <div className="mt-2 max-w-xl text-sm text-gray-500 mx-auto">
            <p>Thank you for funding Ξ{amount} to task: {taskName}.</p>
            {transactionHash && (
              <p className="mt-2">
                Transaction Hash: 
                <a 
