...
const TransakIntegration = ({
  ...
  // Use Transak's test API key
  const [transakApiKey, setTransakApiKey] = useState('your_transak_test_api_key');
        ...
        <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
          ...
          {useMockWidget ? (
            ...
            <div className="p-6 border border-gray-200 rounded-lg bg-white">
              ...
              <button
                onClick={() => {
                  // Create Transak URL - this is a placeholder, replace with actual implementation
