    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Welcome to your organization dashboard</h2>
          <p className="text-gray-600">
            This is a placeholder for the organization dashboard. You are logged in as an organization.
          </p>
          
          {/* Organization details */}
          <div className="mt-6">
            <h3 className="text-md font-medium text-gray-900 mb-2">Organization Details</h3>
            <div className="bg-gray-50 p-4 rounded-md">
              <dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{currentUser?.category || 'Not available'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Account Type</dt>
                  <dd className="mt-1 text-sm text-gray-900">Organization</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Phone</dt>
                  <dd className="mt-1 text-sm text-gray-900">{currentUser?.phone_number || 'Not available'}</dd>
                </div>
                <div>
